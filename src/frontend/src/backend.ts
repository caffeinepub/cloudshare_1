...
import type { Message as _Message, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAssistantName(): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async hasAssistantName(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasAssistantName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: string): Promise<Message> {
        if (this.processError) {
            try {
                ...
                return from_candid_Message_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async setAssistantName(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAssistantName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        assistantName: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.assistantName))
    };
}
...
function to_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        assistantName: value.assistantName ? candid_some(value.assistantName) : candid_none()
    };
}
